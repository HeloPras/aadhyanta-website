...
import { TrendingUp, Shield, Users, BarChart3, ArrowRight, CheckCircle, Menu, X, ChevronRight } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto">
          <div className="max-w-4xl">
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed max-w-2xl">
              Strategic investment solutions backed by 15+ years of excellence. We manage your wealth with precision, transparency, and unwavering commitment to your success.
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                We combine rigorous analysis, innovative strategies, and personalized attention to help you build and preserve wealth across generations. Our approach is grounded in deep market expertise and a commitment to excellence.
              </p>
              <a 
                href="#about" 
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  <CheckCircle className="w-6 h-6 mr-3 flex-shrink-0 mt-0.5" style={{ color: '#B71E52' }} />
                  <span className="text-gray-700">Transparent communication and regular portfolio updates</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="w-6 h-6 mr-3 flex-shrink-0 mt-0.5" style={{ color: '#B71E52' }} />
                  <span className="text-gray-700">Rigorous due diligence and risk management processes</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="w-6 h-6 mr-3 flex-shrink-0 mt-0.5" style={{ color: '#B71E52' }} />
                  <span className="text-gray-700">Access to institutional-quality investment opportunities</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="w-6 h-6 mr-3 flex-shrink-0 mt-0.5" style={{ color: '#B71E52' }} />
                  <span className="text-gray-700">Personalized strategies aligned with your goals</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our teams are known for the quality of their financial thinking and for creating cutting-edge investment strategies.
            </p>
          </div>
                ...
                <ul className="space-y-3 mb-6">
                  {service.features.map((feature, idx) => (
                    <li key={idx} className="flex items-start">
                      <ChevronRight className="w-5 h-5 mr-2 flex-shrink-0 mt-0.5" style={{ color: '#B71E52' }} />
