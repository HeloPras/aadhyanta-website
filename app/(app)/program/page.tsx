...
export default function AcceleratorPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 bg-linear-to-br from-blue-50 via-white to-indigo-50">
        <div className="max-w-7xl mx-auto">
          <div className="max-w-4xl">
            <div
              className="inline-block px-4 py-1 bg-blue-100 rounded-full text-sm font-medium mb-6"
              style={{ color: "#161142" }}
            >
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              Building investment-ready enterprises through comprehensive
              support, market connections, and pathways to capital.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="max-w-4xl mx-auto">
            ...
            <h2
              className="text-3xl md:text-5xl font-bold mb-8 text-center leading-tight"
              style={{ color: "#161142" }}
            >
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-10">
              <p className="text-lg text-gray-600 leading-relaxed mb-6">
                Nepal has promising enterprises with strong products, capable
                teams, and real market demand. But they lack what institutional
                investors require: financial discipline, governance frameworks,
                market validation, and scalable business models.
              </p>
              <p className="text-lg font-semibold" style={{ color: "#161142" }}>
                The Aadhyanta Accelerator Program bridges this gap—transforming
                promising businesses into fundable opportunities through
                structured support, expert mentorship, and direct connections to
                capital and markets.
              </p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {approach.map((item, i) => (
              <div
                key={i}
                className="bg-linear-to-br from-gray-50 to-white border border-gray-200 rounded-lg p-8 hover:shadow-lg transition-shadow duration-300"
              >
                <h3
        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-14 text-center">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Every enterprise receives structured support across five critical
              dimensions
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-14">
            ...
            <p className="text-lg text-gray-600">
              Each addressing specific market opportunities or geographic
              priorities
            </p>
          </div>
          ...
          {tracks.map((track, i) =>
            activeTrack === i ? (
              <div
                key={i}
                className="border border-gray-200 rounded-lg p-10 bg-linear-to-br from-white to-gray-50"
              >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <p className="text-lg text-gray-600 leading-relaxed mb-6">
                Ecosystem building isn't separate from investing—it's
                integrated.
              </p>
              <p className="text-lg text-gray-600 leading-relaxed">
                This integration is our competitive advantage. While other fund
                managers wait for deals to arrive, we actively build the
                enterprises that become tomorrow's investments.
              </p>
            </div>
            <div className="space-y-4">
              {integration.map((item, i) => (
                ...
                >
                  ...
                  />
                  <div>
                    <p className="font-bold mb-1" style={{ color: "#161142" }}>
                      {item.title}
                    </p>
                    <p className="text-sm text-gray-600 leading-relaxed">
                      {item.description}
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white border-y border-gray-100">
        <InfiniteSlider speedOnHover={60}>
          <div className="flex gap-25 items-center align-middle">
            {partners.map((partner) => {
              return (
                <div className="flex w-96   h-full justify-center items-center">
                  <img src={partner.href} className="h-full object-contain" />
                </div>
              )
            })}
          </div>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-linear-to-br from-blue-50 via-white to-indigo-50">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12">
            {/* For Enterprises */}
            <div
              className="bg-white border-2 rounded-xl p-10"
              style={{ borderColor: "#B71E52" }}
            >
              <h3
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                Are you a growth-stage SME ready to scale? The Aadhyanta
                Accelerator provides structured support, market connections, and
                pathways to capital.
              </p>
              <div className="space-y-4 mb-8 pb-8 border-b border-gray-100">
                <div>
                  ...
                  <p className="text-gray-700">
                    6-12 months depending on track
                  </p>
                </div>
                <div>
                  <p
                  ...
                  <p className="text-gray-700">
                    Rolling applications with cohort-based selection
                  </p>
                </div>
              </div>
              <button
            ...
            <div className="bg-white border-2 border-gray-200 rounded-xl p-10">
              ...
              <p className="text-gray-600 leading-relaxed mb-8">
                Looking to design ecosystem programs that create sustainable
                impact? We bring fund management expertise, market connections,
